...
func defaultValues() map[string]interface{} {
	return map[string]interface{}{
		...
		"file.storage_root":                             "/var/lib/edge-collector-api/uploads",
		"jwt.issuer":                                    "edge-collector",
		...
		"acquisition.script.max_source_bytes":           262144,
		"acquisition.script.max_execution_ms":           10000,
		"acquisition.script.max_execution_steps":        100000,
		"acquisition.script.max_modbus_operations":      16,
		"acquisition.script.max_delay_ms":               1000,
		"acquisition.script.max_total_delay_ms":         2000,
		"acquisition.script.max_state_bytes_per_device": 65536,
		"acquisition.script.max_events_per_execution":   16,
		"acquisition.script.max_events_per_device":      100,
		"acquisition.script.max_event_payload_bytes":    65536,
		"acquisition.script.max_print_lines":            100,
		"acquisition.script.max_print_line_bytes":       2048,
		"log.level":                                     "info",
		"log.format":                                    "json",
