...
const docTemplate = `{
    ...
    "paths": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/acquisition.channelRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/v1/acquisition/channels/{id}": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/acquisition.deviceRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/v1/acquisition/devices/{id}/script": {
            "put": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "parameters": [
                    ...
                    {
                        "description": "脚本绑定；scriptId 必须指向已发布脚本",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/acquisition.deviceScriptRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/v1/acquisition/script-states/{id}": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/acquisition.scriptRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/v1/acquisition/scripts/{id}/publish": {
            "post": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/api/v1/acquisition/scripts/{id}/rollback": {
            "post": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/acquisition.scriptRollbackRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/v1/acquisition/scripts/{id}/validate": {
            "post": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/api/v1/acquisition/scripts/{id}/versions": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/mqtt.ApiEnvelope"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
        ...
        "/api/v1/mqtt/commands/{commandId}": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/api/v1/mqtt/config": {
            ...
            "put": {
                ...
                "parameters": [
                    {
                        "description": "MQTT 配置；secret 使用 keep/set/clear",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/mqtt.configRequest"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "acquisition.deviceScriptRequest": {
            "type": "object",
            "properties": {
                "scriptId": {
                    "type": "integer"
        ...
        "acquisition.registerBlockRequest": {
            "type": "object",
            "properties": {
                "functionCode": {
                    "type": "integer"
        ...
        "acquisition.scriptRollbackRequest": {
            "type": "object",
            "properties": {
                "versionId": {
                    "type": "integer"
        ...
        "mqtt.configRequest": {
            ...
            "properties": {
                ...
                "clientPrivateKeyAction": {
                    "$ref": "#/definitions/mqtt.SecretAction"
                },
                "commandJournalMaxRows": {
                    "type": "integer"
                },
                "commandJournalRetentionDays": {
                    "type": "integer"
                },
                "commandPollFairness": {
                    "type": "integer"
