...
const docTemplate = `{
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/internal_acquisition.ApiEnvelope"
                        }
                    }
                }
            },
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/internal_acquisition.channelRequest"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/internal_acquisition.deviceRequest"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        "internal_acquisition.ApiEnvelope": {
            "type": "object",
            "properties": {
                "code": {
                    "type": "integer"
        ...
        "internal_acquisition.channelRequest": {
            "type": "object",
            "properties": {
                "baudRate": {
                    "type": "integer"
        ...
        "internal_acquisition.deviceRequest": {
            "type": "object",
            "properties": {
                "channelId": {
                    "type": "integer"
